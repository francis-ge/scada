...
public class FunTroubleBeckhoffService11 {
	...
	private void readyToReadData(FunTroubleVariableService funTroubleVariableService) {
		valNames = funTroubleVariableService.findEntityByHQL("FROM FunTroubleVariable f WHERE f.plcType.plcCommType.name='beckhoff'");
	...
	public FunTroubleBeckhoffService11(FunTroubleVariableService funTroubleVariableService) {
		this.funTroubleVariableService = funTroubleVariableService;
		
		readyToReadData(funTroubleVariableService);
	}
	
	public FunTroubleBeckhoffService11() {
	}
}
